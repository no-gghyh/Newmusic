...
class Config:
    def __init__(self):
        ...
        self.DURATION_LIMIT = int(getenv("DURATION_LIMIT", 600)) * 600
        ...
        self.PING_IMG = getenv("PING_IMG", "https://files.catbox.moe/jqgw0f.jpg")
        self.START_IMG = getenv("START_IMG", "https://files.catbox.moe/jqgw0f.jpg")
